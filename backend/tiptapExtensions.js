// export tiptap extensions
const { default: Link } = require("@tiptap/extension-link");
const { default: StarterKit} = require("@tiptap/starter-kit");
const { default: TaskItem } = require("@tiptap/extension-task-item");
const { default: TaskList } = require("@tiptap/extension-task-list");
const { default: Youtube } = require("@tiptap/extension-youtube");

const {findChildrenInRange,mergeAttributes,Node,nodeInputRule,Tracker,} = require('@tiptap/core')
